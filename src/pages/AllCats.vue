        ...
        <div class="q-pa-sm">
            ...
            >
                <q-tab-panel name="breeds">
                    ...
                    <div class="col-md-10">
                    <div class="row">
                    <div class="q-pa-sm col-md-4" v-for='(card,index) in cat_card' :key='index'>
                    <cat-card :breed='card' @clickfordetails='gotoPetDetail'/>
                    </div>
...
<script>
import CatCard from "../components/pet101/BreedCard.vue";   
import DietCard from "../components/pet101/DietCard.vue"; 
export default {
    methods:{
        gotoPetDetail(breedName){
            console.log(breedName)
            this.$router.push({name:'BreedDetails'})
        }
    },
     data () {
    return {
